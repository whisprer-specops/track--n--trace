...
impl SkeletraceEngine {
    ...
    fn poll_source(
        ...
        for sample in batch.samples {
            ...
            let provenance = SampleProvenance {
                ...
                transform: vec![
                    ...
                    TransformStep::LatestStateUpdate,
                    if stored.stored_history {
                        TransformStep::HistoryStore
                    } else {
                        TransformStep::LatestStateUpdate
                    },
                ],
        ...
        self.record_event(EngineEvent {
            ...
            metric_id: None,
            message: format!(
                "source poll succeeded: raw={} samples={} stored={}",
                report.raw_records_seen, report.samples_seen, report.samples_stored
            ),
        });

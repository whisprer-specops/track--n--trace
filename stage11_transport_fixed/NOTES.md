...
Stage 11 adds a query/watchlist/alert layer over the clean Stage 10 engine: source-agnostic current-state queries, simple operator watchlists, and alert evaluation over latest values.
